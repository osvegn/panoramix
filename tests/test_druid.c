...
Test(print_druid_sentence, test_print_sentence_DRUID_START, .init=cr_redirect_stdout)
{
    print_druid_sentence(DRUID_START, 0);
    cr_assert_stdout_eq_str("Druid: I'm ready... but sleepy...\n");
}

Test(print_druid_sentence, test_print_sentence_DRUID_REFILL, .init=cr_redirect_stdout)
{
    print_druid_sentence(DRUID_REFILL, 10);
    cr_assert_stdout_eq_str("Druid: Ah! Yes, yes, I'm awake! Working on it! Beware I can only make 10 more refills after this one.\n");
}

Test(print_druid_sentence, test_print_sentence_DRUID_SLEEP, .init=cr_redirect_stdout)
{
