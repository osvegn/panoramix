...
Test(args_management, invalide_arguments_numbers, .init=cr_redirect_stderr)
{
    int ac = 3;
    char *av[5] = {"./panoramix", "1", "2", "3", "4"};
    int numbers[ARGS_NUMBER];
    ...
    cr_assert_stderr_eq_str("USAGE: ./panoramix <nb_villagers> <pot_size> <nb_fights> <nb_refills>\n");
}
